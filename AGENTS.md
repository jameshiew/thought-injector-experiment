...
- `prompts/examples/` ships with starter datasets (`dog_vs_person.jsonl`, `loud_vs_soft.jsonl`, `warm_vs_cool.jsonl`) so you can smoke-test `capture-pairs` before writing custom corpora.
