...
## Baseline
`experiments/honesty/baseline_layer20_seed0.txt`
...
(Full sweeps are logged in `experiments/honesty/sweep_seed4_layer20_22.csv` and `experiments/honesty/sweep_seed7_layer22.csv` for finer-grained inspection.)
...
- **Command:**
  ...
  uv run thought-injector run \
    ...
    --seed 0
  ```
- **Observed text:** `experiments/honesty/layer22_strength0p55_seed8.txt`
